...
rxs::OclContext::OclContext(const OclDevice &device)
{
...
bool rxs::OclContext::init(const std::vector<OclDevice> &devices, std::vector<OclLaunchData> &threads)
{
    if (!m_ctx) {
