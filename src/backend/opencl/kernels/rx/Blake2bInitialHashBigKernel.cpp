...
void rxs::Blake2bInitialHashBigKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void rxs::Blake2bInitialHashBigKernel::setArgs(cl_mem out, cl_mem blockTemplate)
{
...
void rxs::Blake2bInitialHashBigKernel::setBlobSize(size_t size)
{
...
void rxs::Blake2bInitialHashBigKernel::setNonce(uint32_t nonce, uint32_t nonce_offset)
{
