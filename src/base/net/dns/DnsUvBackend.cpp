...
void rxs::DnsUvBackend::resolve(const String &host, const std::weak_ptr<IDnsListener> &listener, const DnsConfig &config)
{
...
bool rxs::DnsUvBackend::resolve(const String &host)
{
...
void rxs::DnsUvBackend::onResolved(int status, addrinfo *res)
{
    m_status = status;
...
void rxs::DnsUvBackend::onResolved(uv_getaddrinfo_t *req, int status, addrinfo *res)
{
