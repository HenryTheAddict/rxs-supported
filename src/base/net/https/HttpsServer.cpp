...
rxs::HttpsServer::HttpsServer(const std::shared_ptr<IHttpListener> &listener) :
    m_listener(listener)
{
}


rxs::HttpsServer::~HttpsServer()
{
...
bool rxs::HttpsServer::setTls(const TlsConfig &config)
{
...
void rxs::HttpsServer::onConnection(uv_stream_t *stream, uint16_t)
{
...
void rxs::HttpsServer::onRead(uv_stream_t *stream, ssize_t nread, const uv_buf_t *buf)
{
